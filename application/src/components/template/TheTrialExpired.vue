<template>
    <div v-if="daysToExpiration < 0 && plan == 'trial' && currentRouteName != 'home' && currentRouteName != 'products' && currentRouteName != 'product' " class="blocked" :style="trialContent == true ? 'background-image: url(https://sbrfiles.s3.amazonaws.com/images/trialexpiration.png)' : ''">
        <lang></lang>
        <!-- Trial expired card -->
        <div class="text-center container-trial" v-if="trialContent == true">
            <div v-if="role == 1">
                ...
                <div class="buttons text-center">
                    <button :disabled="loading" v-loading="loading" @click="upgradePlan()" class="sbr-btn sbr-primary mr-4 mb-5">{{lang["upgrade-plan-button"]}}<i class="el-icon-sell"></i></button>
                    <button @click="trialContent=false;comparisonPlansContent=true;checkoutContent=false;" class="sbr-btn sbr-purple">{{lang["view-plan-comparison"]}} <i class="el-icon-guide"></i></button>
                </div>
            </div>
        ...
        <div class="mt-5 ml-5 mr-5 text-center" v-if="comparisonPlansContent">
            <h3>
                <a @click="comparisonPlansContent = false; trialContent = true;checkoutContent=false;" class="sbr-text-primary" href="javascript:void(0)"> 
