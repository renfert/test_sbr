...
export default {
    ...
    methods: {
        ...
        createNewQuestionEvent: function(){
            ...
            var urlToBeUsedInTheRequest = this.getUrlToMakeRequest("question", "createTemporary");
        ...
        openEditQuestionModal: function(id,question,type,weight,feedback,image){
        ...
        deleteQuestion: function(id){
            ...
            var urlToBeUsedInTheRequest = this.getUrlToMakeRequest("question", "delete");
            axios.post(urlToBeUsedInTheRequest, formData).then(() => {
