<template>
    <div class="main">
        ...
        <div v-else>
                        ...
                        <div class="sortable"  v-for="element in modules" :key="element.id">
                            <li class="module" :id="element.id">
                                <el-collapse accordion>
                                    <el-badge style="color:red;" :value="element.totalLessons" class="item" type="primary">
                                        <el-collapse-item>
                                            <template slot="title">
                                                <!-- Add lesson -->
                                                <el-tooltip class="item" effect="dark" :content="lang['add-new-lesson']" placement="top-start">
                                                    <el-button class="btn-sabiorealm-secondary" data-toggle="tooltip" title="Another one here too" @click.prevent="openLessonsModal(element.id)" type="success"  size="small" icon="el-icon-plus" circle></el-button>
                                                </el-tooltip>

                                                <!-- Edit module -->   
                                                <el-tooltip class="item" effect="dark" :content="lang['edit-module']" placement="top-start">
                                                    <el-button class="btn-sabiorealm" @click.prevent="openEditModuleModal(element.id,element.title,element.required_to_next, element.release_date)" type="primary"  size="small" icon="el-icon-edit" circle></el-button>
                                                </el-tooltip>
                                                ...
                                                <template>
                                                    ...
                                                    >
                                                    <el-button class="btn-sabiorealm-danger" slot="reference" type="danger"  size="small" icon="el-icon-delete" circle></el-button>
                                                    </el-popconfirm>
                                                </template>
                                                <!-- Move module -->
                                                <el-tooltip class="item" effect="dark" :content="lang['reposition-module']" placement="top-start">
                                                    <el-button class="handle" type="purple"  size="small" icon="el-icon-rank" circle></el-button>
                                                </el-tooltip>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-md-6">
                        <div class="text-no-results">
                            ...
                            <el-button  class="btn-sabiorealm mt-1" @click.prevent="openModuleModal()"  type="primary"  size="medium">{{lang["new-module"]}}  </el-button> 
                        </div>
                    </div>
            ...
            <el-button v-if="modules != null" class="btn-sabiorealm mt-5" @click.prevent="openModuleModal()"  type="primary"  size="medium">{{lang["new-module"]}}  </el-button> 
        </div>
        ...
        <!--  Modal lessons -->
        <div>
            <el-dialog  :visible.sync="modalChooseLessons" :title="lang['choose-your-content']" center top="5vh">
                <div class="row">
                    <!-- Video -->
                    <div class="col-xl-3 col-md-3 lesson">
                        <a @click.prevent="emitNewLessonEvent('new-video')">
                            <img  src="@/assets/img/class/video.png" class="img-thumbnail img-responsive lesson-img">
                            <br>
                            <span>Video</span>
                        </a>
                    </div>
                    ...
                    <div class="col-xl-3 col-md-3 lesson">
                        <a @click.prevent="emitNewLessonEvent('new-audio')">
                            <img src="@/assets/img/class/audio.png" class="lesson-img img-thumbnail img-responsive">
                            <br>
                            <span>Audio</span>
                        </a>
                    </div>
                    ...
                    <div class="col-xl-3 col-md-3 lesson">
                        <a @click.prevent="emitNewLessonEvent('new-downloadable')">
                            <img src="@/assets/img/class/downloadable.png" class="lesson-img img-thumbnail img-responsive">
                            <br>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-md-3 lesson">
                        <a @click.prevent="emitNewLessonEvent('new-videoconf')">
                            <img src="@/assets/img/class/videoconf.png" class="lesson-img img-thumbnail img-responsive">
                            <br>
                            <span>Videoconf</span>
                        </a>
                    </div>
...
export default {
    ...
    methods: {
        ...
        deleteModule: function(id){
            ...
            formData.set('id', id);
            var urlToBeUsedInTheRequest = this.getUrlToMakeRequest("module", "delete");
            axios.post(urlToBeUsedInTheRequest, formData).then(() => {
                this.getModules(this.course);  
                this.successMessage();
            }, 
        ...
        reorderModulePositions: function(){
            ...
            var urlToBeUsedInTheRequest = this.getUrlToMakeRequest("module", "reorder");
            axios.post(urlToBeUsedInTheRequest, formData).then(() => {
            /* Success callback */
            },
                function(){
