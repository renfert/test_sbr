        ...
        <el-tabs tab-position="left" v-else>
            <el-tab-pane v-for="(element, index) in questions" :key="element.id">
                ...
                <div class="col-12">
                    ...
                    <h3 class="text-sabiorealm">{{element.question}}</h3>
                    <hr>

                    <!-- Description answer -->
                    <div v-if="element.type_question_id == 1">
                        <h3 class="text-sabiorealm">{{lang["answer"]}}</h3>
                        <exam-correction-student-answer :student-id="studentId" :question-type="1" :question-id="element.id"></exam-correction-student-answer>
                    </div>  
                    ...
                    <div v-if="element.type_question_id == 2">
                        ...
                        <el-row>
                            <el-col :span="24">
                                <h5 class="text-sabiorealm">{{lang["checked-alternatives"]}}</h5>
                                <exam-correction-student-answer :student-id="studentId" :question-type="2" :question-id="element.id"></exam-correction-student-answer>
                            </el-col>
                        </el-row>
                    </div>
                    ...
                    <div v-if="element.type_question_id == 3">
                        <h3 class="text-sabiorealm">{{lang["answer"]}}</h3>
                        <exam-correction-student-answer :student-id="studentId" :question-type="3" :question-id="element.id"></exam-correction-student-answer>
                    </div>
...
export default {
    ...
    methods: {
        getExamQuestions: function(){
            ...
            var urlToBeUsedInTheRequest = this.getUrlToMakeRequest("corrections", "listingQuestions");
        ...
        saveEvaluation: function(){
            ...
            formData.set("studentId", this.studentId);
            var urlToBeUsedInTheRequest = this.getUrlToMakeRequest("question", "correction");
