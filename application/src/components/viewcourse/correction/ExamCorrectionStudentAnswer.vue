      ...
      <div v-for="element in studentAnswer" :key="element.id">
        ...
        <div>
          ...
          <div v-if="element.feedback != null && element.feedback != 'null'">
            ...
            <el-input type="textarea" :rows="5" :value="element.feedback"></el-input>
            <!-- Feedback useful or not -->
            <div v-if="element.feedback_useful == null && roleId == 3">
              <a @click.prevent="avaliateFeedback('yes')" class="text-success pr-2">
          ...
          <div v-else>
            <div v-if="element.automaticFeedback != null && element.automaticFeedback != ''">
              <h3 class="sbr-text-primary">{{lang["feedback"]}}</h3>
              <el-input type="textarea" :rows="5" :value="element.automaticFeedback"></el-input>
              <!-- Feedback useful or not -->
              <div v-if="element.feedback_useful == null && roleId == 3">
                <a @click.prevent="avaliateFeedback('yes')" class="text-success pr-2">
                  <i class="far fa-thumbs-up"></i>
    ...
    <div v-if="questionType == 2">
      ...
      <div v-if="feedback != null">
        ...
        <div v-if="feedbackUseful == null && roleId == 3">
          ...
          <a href="javascript:void(0)" @click.prevent="avaliateFeedback('no')" class="text-danger">
            <i class="far fa-thumbs-down"></i>
          </a>
        </div>
      </div>
      ...
      <div v-else>
        <div v-if="automaticFeedback != null && automaticFeedback != ''">
          <h3 class="sbr-text-primary">{{lang["feedback"]}}</h3>
          <el-input type="textarea" :rows="5" :value="automaticFeedback"></el-input>
          <!-- Feedback useful or not -->
          <div v-if="feedbackUseful == null  && roleId == 3">
            <a
              href="javascript:void(0)"
