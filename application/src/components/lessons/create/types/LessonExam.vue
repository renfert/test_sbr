    ...
    <div>
        <el-dialog  :visible.sync="modalCreateExam" :title="lang['create-new-exam']" center top="5vh" >
            ...
            <div v-if="showexamSecondStep">
                ...
                <el-button v-loading="loading" class="sbr-btn sbr-primary" @click.prevent="changeExamStatus()"  type="primary"  size="medium">{{lang["save-button"]}}</el-button>
            </div>
        </el-dialog>
    </div>
</template>
...
export default {
    ...
    methods: {
        changeExamStatus(){
            ...
            var urlToBeUsedInTheRequest = this.getUrlToMakeRequest("lesson", "changeExamStatus");
