...
<!--  Modal new lesson -->
  <div>
    <el-dialog  :visible.sync="modalEditAudio" :title="lang['edit-lesson']" center  top="5vh">
        <form id="form-lesson-audio-edit" @submit.prevent="edit()">
          ...
          <div class="form-row">
              <div class="form-group col-xl-12 col-md-12">
                  ...
                  <div class="drop-area"> 
                    <!-- Type lesson -->
                    <input type="text" name="type_mylesson_id" value="2">
                    <input :value="audioName" name="path" type="text">
                    <input 
                        class="upload"  
...
export default {
  ...
  mounted(){
    ...
    eventBus.$on('edit-lesson-2', function(response){
      this.modalEditAudio = true;
  ...
  methods: {
    ...
    upload: function(event){
      ...
      formData.append('type', 'lesson-audio')
