        ...
        <form id="form-lesson-pdf-edit" @submit.prevent="edit()">
          ...
          <div class="form-row">
              <div class="form-group col-xl-12 col-md-12">
                  ...
                  <div class="drop-area"> 
                    <!-- Type lesson -->
                    <input type="text" name="type_mylesson_id" value="3">
                    <input :value="pdfName" name="path" type="text">
                    <input 
                        class="upload"  
...
export default {
  ...
  mounted(){
    ...
    eventBus.$on('edit-lesson-3', function(response){
  ...
  methods: {
    ...
    upload: function(event){
      ...
      formData.append('type', 'lesson-pdf')
