            ...
            <el-dialog  :visible.sync="modal" title="Edit product list" center width="40%" top="5vh">
                <form  v-loading="loading">
                    ...
                    <el-tabs type="border-card">
                        ...
                        <!-- Number of courses -->
                        <el-tab-pane>
                            <span slot="label"><i class="el-icon-s-management"></i>  {{lang["courses"]}}</span>
                            <div class="form-row">
                                <div class="form-group col-xl-12 col-md-12">
...
export default {
    ...
    mounted(){
        ...
        eventBus.$on('edit-product-list', function(sectionId){
    ...
    methods: {
        editProductList: function(){
            ...
            var urlToBeUsedInTheRequest = this.getUrlToMakeRequest("site-elements/productList", "edit");
        ...
        getProductList: function(sectionId){
            ...
            axios.post(urlToBeUsedInTheRequest, formData).then((response) => {
                ...
                this.limitListOfCourses = response.data["productList"][0]["number_of_products"];
