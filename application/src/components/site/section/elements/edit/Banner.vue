            ...
            <el-dialog  :visible.sync="modal" title="Banner" center width="40%" top="5vh">
                <form id="form-banner" @submit.prevent="editBanner()"  v-loading="loading">
                    ...
                    <el-tabs type="border-card">
                        <el-tab-pane>
                            <span slot="label"><i class="el-icon-picture-outline"></i> {{lang["image"]}}</span>
                            <div class="form-row">
...
export default {
    ...
    mounted(){
        ...
        eventBus.$on('edit-banner', function(sectionId){
    ...
    methods: {
        editBanner: function(){
            ...
            var urlToBeUsedInTheRequest = this.getUrlToMakeRequest("site-elements/banner", "editBanner");
        ...
        getBanner: function(sectionId){
            this.loading = true;
            var urlToBeUsedInTheRequest = this.getUrlToMakeRequest("site-elements/banner", "getBanner");
