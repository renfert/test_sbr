            ...
            <el-dialog  :visible.sync="modal" :title="lang['testimonial']" center width="40%" top="5vh">
                <form  v-loading="loading">
                    ...
                    <el-tabs type="border-card">
                        ...
                        <!-- Persons -->
                        <el-tab-pane>
                            <span slot="label"><i class="el-icon-user"></i>  {{lang["persons"]}}</span>
                            <div class="form-row">
                                <div class="form-group col-xl-12 col-md-12">
...
export default {
    ...
    mounted(){
        ...
        eventBus.$on('edit-testimonial', function(sectionId){
    ...
    methods: {
        editTestimonial: function(){
            ...
            var urlToBeUsedInTheRequest = this.getUrlToMakeRequest("site-elements/testimonial", "edit");
        ...
        addNewPerson(id){
            ...
            var urlToBeUsedInTheRequest = this.getUrlToMakeRequest("persons", "create");
            axios.post(urlToBeUsedInTheRequest, formData).then(() => {
                this.successMessage();
