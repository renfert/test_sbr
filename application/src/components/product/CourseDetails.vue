  ...
  <div>
            ...
            <div v-if="session == true">
              ...
              <div v-else>
                <el-button
                  ...
                  v-loading="loading"
                >{{lang["take-this-course"]}}</el-button>
              </div>
            </div>
          ...
          <div v-else>
            ...
            <div v-else>
              <el-button
                ...
                class="sbr-btn sbr-primary btn-fix"
              >{{lang["buy-this-course"]}}</el-button>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="course-card">
      ...
      <img
        ...
        :src="getUrlToContents() + 'course/'+photo+''"
        alt
      />
    ...
    <el-dialog :visible.sync="modal" :title="lang['create-account']" center top="5vh">
      <div v-if="createAnAccount" class="fade-in">
        ...
        >
          ...
          <!-- Sign in button -->
          <button
            class="sbr-btn sbr-primary btn-block my-4"
            type="submit"
