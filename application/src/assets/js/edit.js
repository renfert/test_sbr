function ncrs(plan){
    $(document).ready(function(){        
        ...
        // ----------------- Show the module content on modal
                ...
                <div class="row">\
                    ...
                    <div class="col-xl-3">\
                        <div style="cursor:pointer" data-ext="downloaded"  class="user-box lessonContent">\
                            ...
                            <h5><a href="#">Archivos descargables</a></h5>\
                        </div>\
                    </div>\
                    \
                    <div class="col-xl-3">\
                ...
                <div id='accordion'>\
                    <div class='card'>\
                        <div class='card-header' id='headingOne'>\
                            ...
                            <input required  type='text' class='form-control' placeholder='Titulo del modulo' name='titleClass["+x+"]'>\
                            <!-- Time -->\
                            <!-- Modal -->\
                            <div class='modal fade' id='timemodal"+z+"' tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel'\
                            aria-hidden='true'>\
                            ...
                            <div class='input-group-append' data-toggle='tooltip' data-placement='top' title='Fecha de lanzamiento del módulo'>\
                                <a data-toggle='modal' data-target='#timemodal"+z+"' href='javascript:void(0)'>\
                            ...
                            <div class='input-group-append' data-toggle='tooltip' data-placement='top' title='Agregar lección'>\
                                <a href='javascript:void(0)'>\
                                    <span data-mod='"+x+"'  name='0' class='input-group-text btn-teal moduleContent'>\
                            ...
                            <div data-toggle='tooltip' data-placement='top' title='Expandir / contraer' class='input-group-append'>\
                                <a href='#collapseOne"+z+"' data-toggle='collapse' aria-expanded='true' aria-controls='collapseOne' href='javascript:void(0)'>\
                        ...
                        \
                        <div id='collapseOne"+z+"' class='collapse show' aria-labelledby='headingOne' data-parent='#accordion'>\
...
function nLesson(){
    $(document).ready(function() {
    positionControler = $("#positionControler").val();
    var x = $("#c").val(); // Initial field 
    var c = $("#d").val();
        $(document).on("click",".lessonContent",function(e){
            ...
            <li style='padding-top:2%;' class='col-md-12 video'>\
                <div class='form-group row'>\
                    <div class='col-xl-8'>\
                        <div class='input-group'>\
                            <input style='display:none;'   value='"+positionControler+"' type='number' class='positionLesson' name='positionLesson["+controler+"]["+positionControler+"]'>\
                            <input required placeholder='Título de la lección' type='text' name='titleLesson["+controler+"]["+positionControler+"]' class='form-control verify-lesson' />\
                            \
                            <label for='fupload"+c+""+d+"' class='control-label label-bordered hide'>\
                                <i class='mdi mdi-cloud-upload mdi-18px'></i>&nbsp; \
                                <b class='fileName'>Seleccione un archivo</b>\
                            </label>\
                            \
                            <input data-icon='icon"+x+""+c+"' required data-max-size='"+size+"' id='fupload"+x+""+c+"' type='file' accept='"+ext+"' name='lesson' class='fupload form-control inputHidden verify-lesson' />\
                            \
                            <input style='display:none'; type='text' class='putFile' name='nameFile["+controler+"]["+positionControler+"]'> \
                            \
                            ...
                            <div data-toggle='tooltip' data-placement='top' title='Eliminar esta lección' class='input-group-append remove_lesson'>\
                                <a href='javascript:void(0)'>\
            ...
            $("ol.sortableContent").sortable({ 
                ...
                stop: function(event, ui) {
                    $(this).children('li').each(function (index){
                        var elContent = $(this).find("input.posControl").attr("data-type");
                        var el = $(this);
                        if(elContent == "lesson"){
                            el.find("input.positionLessonEdit").val(index);
                        }
                        if(elContent == "exam"){
                            el.find("input.positionExamEdit").val(index);
                        }
                        if(elContent == "webinar"){
                            el.find("input.positionWebinarEdit").val(index);
                        }
                        if(elContent == "videocall"){
                            el.find("input.positionVideoCallEdit").val(index);
                        }
                    });
                }
            });  
        ...
        $(document).on("click",".remove_content",function() {
            var classToDelete = $(this).closest('.col-md-12');
            swal({
                title: "Cuidado!                ",
        ...
        $(document).on("click",".webinar",function(e){
            ...
            <li style='padding-top:2%;' class='col-md-12 video'  id='closeLi"+x+"'>\
                <div class='form-group row'>\
                    <div class='col-xl-8'>\
                        <div class='input-group'>\
                            <input style='display:none' value='"+positionControler+"' type='number' class='positionWebinar' name='positionWebinar["+controler+"]["+x+"]'>\
                            <input required placeholder='Título de lo webinar' type='text' name='titleWebinar["+controler+"]["+x+"]' class='form-control putTitle"+controler+""+x+""+c+"'/>\
                            \
                            <label id='fupload"+x+""+c+"' for='fupload"+x+""+c+"' class='control-label     label-bordered hide' data-toggle='modal' data-target='#myModalWebinar"+x+"'><i class='mdi mdi-check-box-outline mdi-18px'></i>&nbsp; <b class='fileName'>Haga clic para editar el webinar</b>\
                            </label>\
                            \
                                ...
                                <div class='form_webinar'>\
                                    <!-- First step -->\
                                        <div class='text-center first_step'>\
                                            ...
                                            <h4>Título del webinar</h4>\
                                            <input data-info='titulo del webinar' type='text' class='text-field myTitle verify-webinar' id='putTitle"+controler+""+x+""+c+"'>\
                                            <h4>URL del webinar</h4>\
                                            <input data-info='url del webinar' required placeholder='Ex: https://zoom.com/tu-sala' type='text' name='urlWebinar["+controler+"]["+x+"]' class='text-field verify-webinar'/>\
                                            ...
                                            <button type='button'class='ead btn-eadtools-light save_webinar'>GUARDAR <i class='mdi mdi-content-save'></i> </button>\
                                        </div>\
                                        \
                                    </div>\
                                </div>\
        ...
        $(document).on("click",".videocall",function(e){
            ...
            <li style='padding-top:2%;' class='col-md-12 video' id='closeLi"+x+"'>\
                <div class='form-group row'>\
                    <div class='col-xl-8'>\
                        <div class='input-group'>\
                            <input class='hide' value='"+positionControler+"' type='number' class='positionVideocall' name='positionVideoCall["+controler+"]["+x+"]'>\
                            <input required placeholder='Título de la video call' type='text' name='titleVideoCall["+controler+"]["+x+"]' class='form-control putTitle"+controler+""+x+""+c+"'/>\
                            \
                            <label id='fupload"+x+""+c+"' for='fupload"+x+""+c+"' class='control-label label-bordered hide' data-toggle='modal' data-target='#myModalVideocall"+x+"'><i class='mdi mdi-check-box-outline mdi-18px'></i>&nbsp; <b class='fileName'>Haga clic para editar la Videocall</b>\
                            </label>\
                            \
            ...
            \
            <!-- Central Modal Medium Success -->\
            <div class='modal fade' data-backdrop='static' id='myModalVideocall"+x+"' tabindex='-1' role='dialog' aria-labelledby='myModalLabel' aria-hidden='true'>\
                <div class='modal-dialog modal-notify modal-lg' role='document'>\
                    <!--Content-->\
                        <div class='modal-content'>\
...
$(document).ready(function() {
    ...
    var c = $("#j").val();
        $(document).on("click","#exam",function(e){
                ...
                <div class='form-group row'>\
                    <div class='col-xl-8'>\
                        <div class='input-group'>\
                            ...
                            <input required placeholder='Título de lo exam' type='text' name='titleExam["+controler+"]["+x+"]' class='form-control putTitle"+controler+""+x+""+c+"'/>\
                            \
            ...
            \
            <!-- Central Modal Medium Success -->\
            <div class='modal fade' id='myModalMultiple"+x+"' tabindex='-1' role='dialog' aria-labelledby='myModalLabel' aria-hidden='true'>\
                <div class='modal-dialog modal-notify modal-lg' role='document'>\
                    <!--Content-->\
                        <div class='modal-content'>\
                            ...
                            <div class='modal-body'>\
                                <div class='form_exam'>\
                                    <!-- First step -->\
                                        ...
                                        <h2>Preguntas</h2>\
                                        <span class='text-info'>Haga clic en cualquier pregunta para agregarla</span>\
                                        <hr>\
                                            <div class='questions'>\
                                                <!-- Multiple choice -->\
                                            ...
                                            <div class='row'>                           \
                                                ...
                                                <div class='col-4'>\
                                                    <div class='list-group list-group-horizontal-xl' id='list-tab' role='tablist'>\
                                                        ...
                                                        <li style='display:none;' class='list-group-item text-white order'><span class='text-dark'>Ordenar preguntas</span></li>\
                                                        </ol>\
                                                    </div>\
                                            ...
                                            <div class='modal-footer justify-content-center'>\
                                                ...
                                                <button type='button' data-close='myModalMultiple"+x+"' class='ead btn-eadtools-light save_exam'>GUARDAR <i class='mdi mdi-content-save'></i> </button>\
                                            </div>\
                                        </div>\
                                    </div>\
                                </div>\
...
function nQuestion(){
    $(document).ready(function() {  
        ...
        $(document).on("click", ".multiple_question", function(e){
            ...
            var addMultiple = $("\
            <li id='question"+controlQuest+"' class='list-group-item text-white pointer navQuestions "+style+" '>\
                ...
                <i data-toggle='tooltip'  data-placement='top' title='Mover' class='mdi mdi-cursor-move mdi-18px md-6 text-primary handlerQuestion text-primary pointer' style='padding-right:10%;'></i> <span class='question_text'></span>  \
                <input type='number' name='positionQuestion["+exam+"]["+controlQuest+"]' style='display:none;' class='position_question' value="+l+">\
            </li>\
            ");
            ...
            var addContentMultiple = $("\
                <div "+display+" class='question"+controlQuest+" myContent'>\
                    ...
                    <textarea data-name='pregunta "+x+" ' rows='5' required name='question["+exam+"]["+controlQuest+"]' type ='text' class='text-field questionValidation'></textarea>\
                    ...
                    <!-- Answer -->\
                    <div data-name='pregunta "+controlQuest+" ' class='putAnswer"+exam+""+controlQuest+" verifyAnswer'>\
                    \
                    </div>\
                </div>\
            ");
            ...
            $("ol.sortableQuestion").sortable({ 
                ...
                stop: function(event, ui) {
                    $(this).children().each(function (index){
                        ...
                        $(this).find("span.question_text").html("Pregunta "+index+"");
                    });
                }
            });
        ...
        $(document).on("click",".descriptive_question", function(){
            ...
            $(".order").show();
            var addDescriptive = $("\
            <li id='question"+controlQuest+"' class='list-group-item text-white pointer navQuestions'>\
                <i data-toggle='tooltip' data-placement='top' title='Borrar' class='mdi mdi-trash-can mdi-18px md-6 text-danger pointer remove_question'></i>\
                <i data-toggle='tooltip'  data-placement='top' title='Mover' class='mdi mdi-cursor-move mdi-18px md-6 handlerQuestion text-primary pointer' style='padding-right:10%;'></i> <span class='question_text'>Pregunta "+controlQuest+"</span> \
                <input type='number' name='positionQuestion["+exam+"]["+controlQuest+"]' style='display:none;' class='position_question' value="+l+">\
            </li>\
            ");
            if(controlQuest == 1){
            ...
            var addContentDescriptive = $("\
                <div "+display+" class='question"+controlQuest+" myContent'>\
                    ...
                    <h5  class='text-left'>Escribe tu pregunta</h5>\
                    <textarea data-name='pregunta "+controlQuest+" ' rows='5' required name='question["+exam+"]["+controlQuest+"]' type='text' class='text-field questionValidation' maxlength='700'></textarea>\
        ...
        $(document).on("click",".free_question", function(){
            ...
            var addContentFree = $("\
                <div "+display+" class='question"+controlQuest+" myContent'>\
                    ...
                    <h5 class='text-left'>Escribe tu pregunta</h5>\
                    <textarea data-name='pregunta "+controlQuest+" ' rows='5' required name='question["+exam+"]["+controlQuest+"]' class='text-field questionValidation'></textarea>\
            ...
            var addAnswer = $("\
                <div class='col-12'>\
                    <div class='input-group mb-2'>\
                        ...
                        <div class='input-group-prepend'>\
                            <div class='input-group-text'>\
                                <div data-toggle='tooltip' data-placement='top' title='Respuesta correcta' class='custom-control custom-radio'>\
